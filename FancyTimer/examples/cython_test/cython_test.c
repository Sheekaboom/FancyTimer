...
static const char __pyx_k_Created_on_Tue_Oct_8_13_30_21_2[] = "\nCreated on Tue Oct  8 13:30:21 2019\n\n@author: aweiss\n";
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "cython_test",
    __pyx_k_Created_on_Tue_Oct_8_13_30_21_2, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
...
if (!__Pyx_RefNanny) {
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cython_test", __pyx_methods, __pyx_k_Created_on_Tue_Oct_8_13_30_21_2, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
